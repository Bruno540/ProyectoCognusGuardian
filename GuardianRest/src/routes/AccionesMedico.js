...
const { obtenerDatos, obtenerGuardias, obtenerGuardiasDisponibles, postularseGuardia, getEspecialidadesGuardia, obtenerPostulaciones, cancelarPostulacion, ofrecerLiberarGuardia, actualizarDatos, sincronizarCalendario, confirmarSyncCalendar, agregarTelefono, verificarTelefono, sincronizarTelefono, passwordChange, obtenerGuardiasCompletadas } = require('../controllers/acciones.medico');
const handleError = require('../helpers/error.check');
const { validatePostularseGuardia, validateIdGuardia } = require('../validation/validation');
...
router.get('/especialidades/:idguardia', handleError(getEspecialidadesGuardia));
